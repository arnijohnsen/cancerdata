...
dataFileDir = "../rawdata/KIRC/Methylation/DNA_Methylation/JHU_USC__HumanMethylation450/Level_3/"
...
# Save to files
save(cancerMethyl, file="../Rdata/KIRC/data/KIRC-CMP.Rdata")
save(probeList,    file="../Rdata/KIRC/info/probeList.Rdata")
save(cancerMethylSampList, file="../Rdata/KIRC/info/methylSampList.Rdata")
quit(save="no")
