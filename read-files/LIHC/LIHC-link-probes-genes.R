...
load("../Rdata/LIHC/info/LIHC-probes.Rdata")
load("../Rdata/LIHC/info/LIHC-genes.Rdata")

# Filter probe.annotation with probes in use
probe.annotation <- probe.annotation[probe.annotation$TargetID %in% LIHC.probes,]
