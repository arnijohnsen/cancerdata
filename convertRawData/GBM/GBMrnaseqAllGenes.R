...
save(cancerRnaseq, file="../Rdata/GBM/cancerRnaseqAllGenes.Rdata")
save(genesList,    file="../Rdata/GBM/genesList.Rdata")
save(cancerRnaseqSampList, file="../Rdata/GBM/rnaseqSampList.Rdata")
quit(save="no")
